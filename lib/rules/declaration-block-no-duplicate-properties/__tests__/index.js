...
testRule({
	ruleName,
	config: [true, { lookAtCustomProperties: true }],
...
testRule({
	ruleName,
	config: [true, { ignore: ['consecutive-duplicates'], lookAtCustomProperties: true }],
	skipBasicChecks: true,
...
testRule({
	...
	config: [
		true,
		{ ignore: ['consecutive-duplicates-with-different-values'], lookAtCustomProperties: true },
	],
	skipBasicChecks: true,
...
testRule({
	ruleName,
	config: [true, { ignoreProperties: ['--custom-property'], lookAtCustomProperties: true }],
	skipBasicChecks: true,
...
testRule({
	ruleName,
	config: [true, { ignoreProperties: ['/--custom-/'], lookAtCustomProperties: true }],
	skipBasicChecks: true,
